...
supernovas.post('/seed', async (c) => {
  ...
  // Reward rules:
  // - green supernova: green 1 (×tier)
  // - red supernova: green 10, red 1 (×tier)
  // - blue supernova: green 100, red 10, blue 1 (×tier)
  // - purple supernova: green 1000, red 100, blue 10, purple 1 (×tier)
  // Tier multipliers: 1st=1, 2nd=2, 3rd=3, 4th=5
