...
- 各色の星の下に、その色の数字（枠付きテキスト、リプライ数等と同じスタイル）
- 数字部分をクリックすると、その色のリアクター一覧ポップアップが表示
- 星部分をクリックすると、カラーピッカーが表示
...
数字をクリックすると、その色のリアクター一覧がポップアップ表示される:
