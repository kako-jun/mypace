...
| `magazine` | [magazine.md](./magazine.md)       | 投稿をまとめるコレクション機能 |
...
| Share as Image  | [share-as-image.md](./share-as-image.md)   | 投稿カード・ワードロットを画像化してシェア |
...
| 機能         | ドキュメント                         | 概要                          |
| ------------ | ------------------------------------ | ----------------------------- |
| Teaser       | [teaser.md](./teaser.md)             | 長文フォールド / ステラ必須   |
| User Mention | [user-mention.md](./user-mention.md) | @username形式のユーザーリンク |
